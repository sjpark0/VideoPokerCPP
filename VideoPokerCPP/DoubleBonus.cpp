...
bool FourCARD_A(CARD *card)
{
	bool result = false;
	if((card[0].number == card[3].number && card[0].number == 1) || (card[1].number == card[4].number && card[1].number == 1)){
		result = true;
	}
	return result;
}
bool FourCARD_234(CARD *card)
{
	bool result = false;
	if((card[0].number == card[3].number && card[0].number >= 2 && card[0].number <= 4) || (card[1].number == card[4].number && card[1].number >= 2 && card[1].number <= 4)){
		result = true;
	}
	return result;
}
...
int ReturnCredit(CARD *card, int bet)
{
	...
	else if(FourCARD_A(card)){
		result = bet * 160;
	}
	else if(FourCARD_234(card)){
		result = bet * 80;
	}
...
void PrintHand(CARD *card)
{
    if(RoyalFlush(card)){
		...
		cout << "Four CARD Aces" << endl;
	}
	else if(FourCARD_234(card)){
		cout << "Four CARD 2, 3, 4" << endl;
	}
    else if(FourCARD(card)){
        cout << "Four CARD" << endl;
    }
